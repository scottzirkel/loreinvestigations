    ...
    <main className="mx-auto px-4 text-center md:px-12 lg:max-w-7xl">
      <div className="mx-auto max-w-2xl space-y-2 p-4 text-lg text-stone-200">
        <p>
          ...
          Nathan and TJ. Their first case is The Creepy Barn, in which they go
          up against what is possibly a possessed teenage girl. Of course,
          it&apos;s hard to tell a regular teenage girl from one possessed by a
          ghost.
        </p>
        <p>
          ...
          . Jason Worthington is on inks and Juan Carlos Porras bringing up the
          colors.
        </p>
      </div>
      ...
      <section className="mt-8">
        <Image
          width={1184}
          height={1831}
          src="https://cdn.scottzirkel.com/prod/comics/com_Z3caUdQrqoN1HlfMsJ7rQ/images/743c857524a2174eba3c2a3cc69bb696/cover.jpg"
          alt="cover"
          loading="eager"
        />
        <Image
